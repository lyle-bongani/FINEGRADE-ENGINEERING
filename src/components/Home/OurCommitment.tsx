        ...
        <section className="w-full py-20 bg-white">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 px-4 md:px-8">
                ...
                <div className="flex-1" ref={textRef}>
                    <h2 className="text-4xl md:text-5xl font-extrabold text-orange-500 mb-2 mt-2 text-left">Our Commitment</h2>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-800 text-base md:text-lg text-left">
                        <li><span className="font-bold text-orange-500">Quality Assurance:</span> We are committed to delivering the highest quality products and services that meet or exceed industry standards.</li>
                        <li><span className="font-bold text-orange-500">Safety First:</span> Safety is paramount. We prioritize the safety of our employees, subcontractors, and clients in all our operations.</li>
                        <li><span className="font-bold text-orange-500">Environmental Responsibility:</span> We are committed to minimizing our environmental impact and promoting sustainable practices.</li>
                        <li><span className="font-bold text-orange-500">Continuous Improvement:</span> We strive for continuous improvement in all aspects of our business, from project execution to customer service.</li>
                    </ul>
                </div>
                {/* Image */}
