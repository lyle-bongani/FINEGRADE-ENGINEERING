...
const HomeAbout: React.FC = () => {
    return (
        <section className="w-full flex flex-col md:flex-row justify-start py-10 md:py-20 bg-transparent relative">
            ...
            <div className="max-w-3xl w-full relative z-20 px-4 md:pl-32 md:pr-8">
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-blue-500 mb-2 mt-2 text-left">About Finegrade Safety & Equipment</h2>
                <div className="text-blue-400 text-base sm:text-lg font-semibold mb-6 text-left">Safety is not just a policy—it's our culture.</div>
