            ...
            <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row md:items-start md:justify-between gap-8">
                ...
                <div className="flex flex-col items-start md:w-1/4 mb-8 md:mb-0 text-left">
                    ...
                    <div className="flex gap-3 mt-2">
                        <a href="#" className="bg-orange-100 rounded p-2 hover:bg-orange-500 transition"><Facebook size={22} className="text-orange-500" /></a>
                        <a href="#" className="bg-orange-100 rounded p-2 hover:bg-orange-500 transition"><Linkedin size={22} className="text-orange-500" /></a>
                    </div>
                </div>
                {/* Offices */}
                <div className="flex-1 flex flex-col md:flex-row gap-8 justify-center text-left">
                    <div>
                        ...
                        <div className="w-10 h-1 bg-orange-500 mb-4 rounded" />
                        <div className="flex items-center gap-2 mb-2"><MapPin size={18} className="text-orange-400" />161 Gleneagles Road, Southerton, Harare</div>
                        <div className="flex items-center gap-2"><Phone size={18} className="text-orange-400" />+263 242 661 304</div>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold mb-2">Bulawayo Office</h3>
                        <div className="w-10 h-1 bg-orange-500 mb-4 rounded" />
                        <div className="flex items-center gap-2 mb-2"><MapPin size={18} className="text-orange-400" />4 Sheffield Road, Belmont, Bulawayo</div>
                        <div className="flex items-center gap-2"><Phone size={18} className="text-orange-400" />+263 292 260 106</div>
                    </div>
                </div>
                {/* Gallery */}
